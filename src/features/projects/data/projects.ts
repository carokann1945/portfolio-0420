...
export type ProjectLink = { label: string; href: string; icon?: string | StaticImageData };
...
export const PROJECTS: Project[] = [
  {
    index: '01',
    name: 'Cernium',
    period: '2026.03 ~ 꾸준한 업데이트',
    description:
      'Cernium은 영어 및 해외 시간대(UTC, PDT) 기반 GMS(글로벌 메이플스토리) 공지의 낮은 접근성과, 이벤트 정보가 분산된 문제를 해결하기 위해 제작했습니다. 2026년 3월부터 개발 중이며 DAU 50명 규모로 운영되고 있습니다. Next.js와 Typescript 기반으로 제작되었으며 데이터 수집을 위한 서브 프로젝트는 Node.js 기반으로 제작되었습니다.',
    tags: ['Next.js', 'TypeScript', 'Tailwind', 'Node.js'],
    image: { src: cerniumDesktop, alt: 'Cernium preview' },
    links: [
      { label: 'README', href: '#', icon: readmeIcon },
      { label: 'Github', href: 'https://github.com/carokann1945/cernium', icon: githubIcon },
    ...
    subProject: {
      ...
      links: [
        { label: 'README', href: '#', icon: readmeIcon },
        { label: 'Github', href: 'https://github.com/carokann1945/gms-tracker', icon: githubIcon },
      ],
    },
  },
  {
    ...
    links: [
      { label: 'README', href: '#', icon: readmeIcon },
      { label: 'Github', href: 'https://github.com/carokann1945/carokann', icon: githubIcon },
